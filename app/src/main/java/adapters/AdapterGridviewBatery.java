...
public class AdapterGridviewBatery extends BaseAdapter {
    ...
    public AdapterGridviewBatery(Context context) {
        ...
        title = new String[]{context.getResources().getString(R.string.wifi)+"", context.getResources().getString(R.string.data)+"", context.getResources().getString(R.string.Brightness) + "", context.getResources().getString(R.string.Volumen) + "", context.getResources().getString(R.string.GPS) + "", context.getResources().getString(R.string.Timeout) + ""};
...
//    public String[] title = {"WIFI", "Data", "Brightness", context.getResources().getString(R.string.Volumen) + "", context.getResources().getString(R.string.GPS) + "", context.getResources().getString(R.string.Timeout) + ""};

    public String[] title ;//= {context.getResources().getString(R.string.wifi)+"", context.getResources().getString(R.string.data)+"", context.getResources().getString(R.string.Brightness) + "", context.getResources().getString(R.string.Volumen) + "", context.getResources().getString(R.string.GPS) + "", context.getResources().getString(R.string.Timeout) + ""};

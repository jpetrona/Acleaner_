...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
    ...
    public void barraTitulo() {
        ...
        SpannableString s = new SpannableString(getResources().getString(R.string.IgnoreList));
        s.setSpan(new TypefaceSpan(this, "Roboto-Bold.ttf"), 0, s.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            for (int index = 0; index < pids.size(); index++) {
                ...
                if ((memoryInfoArray != null) && (memoryInfoArray.length > 0)) {
                    ...
                    final String packName = packages.get(index);
                    try {
